...
<html lang="en">
	...
	<head>
		...
		<title>Messages | Nadhif - Responsive Admin Template</title>
		...
		<div class="navbar" role="navigation">
			<div class="container-fluid container-nav">
				...
				<ul class="nav navbar-nav navbar-actions navbar-left">
					<li class="visible-md visible-lg"><a href="page-inbox-message.html#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
					<li class="visible-xs visible-sm"><a href="page-inbox-message.html#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>			
				</ul>
				<!-- Navbar Left -->
						...
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<div class="panel">
								<div class="panel-body bk-bg-very-light-gray mailbox-menu">
									...
									<ul>
										<li>
											<a href="page-inbox.html">Inbox<span class="label label-primary">165</span></a>
										</li>
										<li>
											<a href="page-inbox-compose.html#">Stared</a>
										</li>
										<li>
											<a href="page-inbox-compose.html#">Sent Mail</a>
										</li>
										<li>
											<a href="page-inbox-compose.html#">Important<span class="label label-info">7</span></a>
										</li>
										<li>
											<a href="page-inbox-compose.html#">Draft<span class="label label-warning">3</span></a>
										</li>
										<li>
											<a href="page-inbox-compose.html#"></i>Trash</a>
										</li>
										<hr />
										<h5 class="bk-fg-primary">Labels</h5>
										<li>
											<a href="page-inbox-compose.html#">Work <span class="ball pink"></span></span></a>
										</li>
										<li>
											<a href="page-inbox-compose.html#">Private <span class="ball green"></span></a>
										</li>
										<li>
											<a href="page-inbox-compose.html#">Clients <span class="ball blue"></span></a>
										</li>
										<li>
											<a href="page-inbox-compose.html#">Travel <span class="ball orange"></span></a>
										</li>										
									</ul>									
								</div>									
							</div>							
							<div class="panel">
								<div class="panel-body bk-bg-very-light-gray mailbox-chat">
									<h5 class="bk-fg-primary">Live Chat</h5>
									<ul>
										<li><span class="ball green"></span> Sarah Hiltser</li>
										<li><span class="ball green"></span> Stephano Odo</li>
										<li><span class="ball green"></span> Malras</li>
										<li><span class="ball dark"></span> Derbi Mondro</li>
										<li><span class="ball green"></span> Jessy Doe</li>
										<li><span class="ball orange"></span> Gerry</li>
										<li><span class="ball green"></span> Kevin</li>
										<li><span class="ball yellow"></span> Carlina Minfa</li>										
									</ul>								
								</div>							
							</div>
						</div>					
						<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">							
							<div class="panel bk-bg-white">								
								<div class="panel-body message mailbox-btn-action">
									...
									<div class="col-md-12">
										<div class="message-title">Contrary to popular belief, Lorem Ipsum is not simply random text.</div>
										<div class="header">
											...
											<div class="date"><span class="fa fa-paper-clip"></span> Today, <b>08:45 AM</b></div>
											<div class="menu"></div>
										</div>
										<div class="content">
											<p>
											...
											<ul>
												<li class="col-xs-12">
													...
													<span class="quickMenu">
														<a href="page-inbox-message.html#" class="fa fa-search"><i></i></a>
														<a href="page-inbox-message.html#" class="fa fa-share"><i></i></a>
														<a href="page-inbox-message.html#" class="fa fa-cloud-download"><i></i></a>
													</span>
												</li>
												<li class="col-xs-12">
													<span class="label label-info">txt</span> <b>File.txt</b> <i>(7KB)</i>
													<span class="quickMenu">
														<a href="page-inbox-message.html#" class="fa fa-search"><i></i></a>
														<a href="page-inbox-message.html#" class="fa fa-share"><i></i></a>
														<a href="page-inbox-message.html#" class="fa fa-cloud-download"><i></i></a>
												...
												<li class="col-xs-12">
													<span class="label label-success">xls</span> <b>File.xls</b> <i>(984KB)</i>
													<span class="quickMenu">
														<a href="page-inbox-message.html#" class="fa fa-search"><i></i></a>
														<a href="page-inbox-message.html#" class="fa fa-share"><i></i></a>
														<a href="page-inbox-message.html#" class="fa fa-cloud-download"><i></i></a>
												...
												<li class="col-xs-12">
													<span class="label label-success">zip</span> <b>File.zip</b> <i>(1.25MB)</i>
													<span class="quickMenu">
														<a href="page-inbox-message.html#" class="fa fa-search"><i></i></a>
														<a href="page-inbox-message.html#" class="fa fa-share"><i></i></a>
														<a href="page-inbox-message.html#" class="fa fa-cloud-download"><i></i></a>
										...
										<div class="panel" id="message-reply">								
											<div class="panel-body message-reply">
												<div class="mailbox-compose" data-mailbox data-mailbox-view="compose">											
													<div class="compose">
