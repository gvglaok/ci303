...
<html lang="en">
	...
	<head>
		...
		<title>Typography | Nadhif - Responsive Admin Template</title>
	...
	<body>
				...
				<div class="main ">
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li class="active"><i class="fa fa-font"></i>Typography</li>
							</ol>						
						</div>
					...
					<div class="row">					
						<div class="col-lg-6">
							<div class="panel bk-bg-white">                        
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-font red"></i>Headings</h6>
						...
						<div class="col-lg-6">
							<div class="panel bk-bg-white">                        
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-font red"></i>Paragraph text</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times"></i></a>
						...
						<div class="col-lg-6">
							<div class="panel bk-bg-white">                        
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-font red"></i>Text Colors</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times"></i></a>
					...
					<div class="row">					
						<div class="col-lg-12">
							<div class="panel bk-bg-white">                        
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-font red"></i>Emphasis</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times"></i></a>
							...
							<div class="panel bk-bg-white">                        
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-font red"></i>Blockquotes</h6> 
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times"></i></a>
		...
		&lt;/blockquote&gt;</code></pre>
						...
						<div class="col-lg-12">
							<div class="panel bk-bg-white">                        
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-font red"></i>Alignment classes</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times"></i></a>
					...
					<div class="row">						
						<div class="col-lg-8">
							<div class="panel bk-bg-white">                        
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-font red"></i>Well</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times"></i></a>
						...
						<div class="col-lg-4">
							<div class="panel bk-bg-white">                        
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-font red"></i>Addresses</h6>                            
								</div>
								<div class="panel-body">
									<address>
						...
						<div class="col-md-4">
							<div class="panel bk-bg-white">                        
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-font red"></i>Ordered List</h6>
								</div>
								<div class="panel-body">
									<ol>
						...
						<div class="col-md-4">
							<div class="panel bk-bg-white">
								<div class="panel-heading bk-bg-primary" data-original-title>
									<h6><i class="fa fa-font red"></i>Unordered List</h6>
								</div>
								<div class="panel-body">
									<ul>
									  <li>Lorem ipsum dolor sit amet</li>
						...
						<div class="col-md-4">
							<div class="panel bk-bg-white">
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-font red"></i>Description List</h6>
								</div>
								<div class="panel-body">
									<dl>
