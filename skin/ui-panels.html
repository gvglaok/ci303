...
<html lang="en">
	...
	<head>
		...
		<title>UI Panels | Nadhif - Responsive Admin Template</title>
	...
	<body>
		...
		<div class="navbar" role="navigation">
			<div class="container-fluid container-nav">
				...
				<ul class="nav navbar-nav navbar-actions navbar-left">
					<li class="visible-md visible-lg"><a href="ui-panels.html#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
					<li class="visible-xs visible-sm"><a href="ui-panels.html#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>			
				</ul>
				<!-- Navbar Left -->
				...
				<div class="main ">
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li class="active"><i class="fa fa-list-alt"></i>Panels</li>
							</ol>						
						</div>
						...
						<div class="col-md-6">
							<div class="panel panel-primary">
								<div class="panel-heading">
									<h6><i class="fa fa-signal red"></i>Title</h6>
									<div class="panel-actions">
										<a href="ui-panels.html#" class="btn-setting"><i class="fa fa-rotate-right"></i></a>
										<a href="ui-panels.html#" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
										<a href="ui-panels.html#" class="btn-close"><i class="fa fa-times"></i></a>
									</div>
								</div>
								<div class="panel-body">
									Content.
								...
								<div class="panel-heading">
									<div class="row">
										<div class="col-xs-8 text-left bk-vcenter">
											<h6 class="bk-margin-off">Title</h6>
										</div>
						...
						<div class="col-sm-6">								
								...
								<div class="panel-heading">
									<div class="row">
										<div class="col-xs-12 text-left bk-vcenter">
											<h6 class="bk-margin-off">Panel default</h6>
										</div>
									</div>
								</div>
								<div class="panel-body">
							...
							<div class="panel panel-primary">
								<div class="panel-heading">
									<div class="row">
										<div class="col-xs-12 text-left bk-vcenter">
											<h6 class="bk-margin-off">Panel Primary</h6>
										</div>
									</div>
								</div>
								<div class="panel-body">
						...
						<div class="col-sm-6">	
							<div class="panel panel-success">
								<div class="panel-heading">
									<div class="row">
										<div class="col-xs-12 text-left bk-vcenter">
											<h6 class="bk-margin-off">Panel Success</h6>
										</div>
									</div>
								</div>
								<div class="panel-body">
						...
						<div class="col-sm-6">	
							<div class="panel panel-info">
								<div class="panel-heading">
									<div class="row">
										<div class="col-xs-12 text-left bk-vcenter">
											<h6 class="bk-margin-off">Panel Info</h6>
										</div>
									</div>
								</div>
								<div class="panel-body">
						...
						<div class="col-sm-6">
							<div class="panel panel-warning">
								<div class="panel-heading">
									<div class="row">
										<div class="col-xs-12 text-left bk-vcenter">
											<h6 class="bk-margin-off">Panel Warning</h6>
										</div>
									</div>
								</div>
								<div class="panel-body">
						...
						<div class="col-sm-6">	
							<div class="panel panel-danger">
								<div class="panel-heading">
									<div class="row">
										<div class="col-xs-12 text-left bk-vcenter">
											<h6 class="bk-margin-off">Panel Danger</h6>
										</div>
									</div>
								</div>
								<div class="panel-body">
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6><i class="fa fa-signal red"></i>Panel Default</h6>
									<div class="panel-actions">
										<a href="ui-panels.html#" class="btn-setting"><i class="fa fa-rotate-right"></i></a>
										<a href="ui-panels.html#" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
										<a href="ui-panels.html#" class="btn-close"><i class="fa fa-times"></i></a>
							...
							<div class="panel panel-primary">
								<div class="panel-heading">
									<h6><i class="fa fa-signal red"></i>Panel Primary</h6>
									<div class="panel-actions">
										<a href="ui-panels.html#" class="btn-setting"><i class="fa fa-rotate-right"></i></a>
										<a href="ui-panels.html#" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
										<a href="ui-panels.html#" class="btn-close"><i class="fa fa-times"></i></a>
						...
						<div class="col-sm-6">
							<div class="panel panel-success">
								<div class="panel-heading">
									<h6><i class="fa fa-signal red"></i>Panel Success</h6>
									<div class="panel-actions">
										<a href="ui-panels.html#" class="btn-setting"><i class="fa fa-rotate-right"></i></a>
										<a href="ui-panels.html#" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
										<a href="ui-panels.html#" class="btn-close"><i class="fa fa-times"></i></a>
						...
						<div class="col-sm-6">
							<div class="panel panel-info">
								<div class="panel-heading">
									<h6><i class="fa fa-signal red"></i>Panel Info</h6>
									<div class="panel-actions">
										<a href="ui-panels.html#" class="btn-setting"><i class="fa fa-rotate-right"></i></a>
										<a href="ui-panels.html#" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
										<a href="ui-panels.html#" class="btn-close"><i class="fa fa-times"></i></a>
						...
						<div class="col-sm-6">
							<div class="panel panel-warning">
								<div class="panel-heading">
									<h6><i class="fa fa-signal red"></i>Panel Warning</h6>
									<div class="panel-actions">
										<a href="ui-panels.html#" class="btn-setting"><i class="fa fa-rotate-right"></i></a>
										<a href="ui-panels.html#" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
										<a href="ui-panels.html#" class="btn-close"><i class="fa fa-times"></i></a>
						...
						<div class="col-sm-6">
							<div class="panel panel-danger">
								<div class="panel-heading">
									<h6><i class="fa fa-signal red"></i>Panel Danger</h6>
									<div class="panel-actions">
										<a href="ui-panels.html#" class="btn-setting"><i class="fa fa-rotate-right"></i></a>
										<a href="ui-panels.html#" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
										<a href="ui-panels.html#" class="btn-close"><i class="fa fa-times"></i></a>
					...
					<div class="row">				
						<div class="col-sm-6">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h6 class="panel-title">Panel Default</h6>
								</div>
								<div class="panel-body">
									Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.
								</div>
					...
					<div class="row">						
						<div class="col-sm-6">								
							<div class="panel">
								<div class="panel-heading bk-bg-very-light-gray">
									<div class="row">
										<div class="col-xs-12 text-left bk-vcenter">
											<h6 class="bk-margin-off">Panel default</h6>
										</div>
					...
					<div class="row">				
						<div class="col-sm-6">
							<div class="panel">
								...
								<div class="panel-footer bk-bg-very-light-gray">Panel footer</div>
							</div>
							<div class="panel">
								<div class="panel-heading bk-bg-primary">
									<h6 class="panel-title">Panel Primary</h6>
								...
								<div class="panel-footer bk-bg-primary">Panel footer</div>
							</div>	
						</div>
						<div class="col-sm-6">
							<div class="panel">
								...
								<div class="panel-footer bk-bg-success">Panel footer</div>
							</div>	
						</div>
						<div class="col-sm-6">
							<div class="panel">
								...
								<div class="panel-footer bk-bg-info">Panel footer</div>
							</div>	
						</div>
						<div class="col-sm-6">
							<div class="panel">
								...
								<div class="panel-footer bk-bg-warning">Panel footer</div>
							</div>	
						</div>
						<div class="col-sm-6">
							<div class="panel">
								...
								<div class="panel-footer bk-bg-danger">Panel footer</div>
							</div>	
						</div>
					</div>
				</div>
		...
		<!-- Pages JS -->
		<script src="assets/js/pages/ui-panels.js"></script>
