...
<html lang="en">
	...
	<head>
		...
		<title>Invoice | Nadhif - Responsive Admin Template</title>
		...
		<div class="navbar" role="navigation">
			<div class="container-fluid container-nav">
				...
				<ul class="nav navbar-nav navbar-actions navbar-left">
					<li class="visible-md visible-lg"><a href="page-invoice.html#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
					<li class="visible-xs visible-sm"><a href="page-invoice.html#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>			
				</ul>
				<!-- Navbar Left -->
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li class="active"><i class="fa fa-credit-card"></i>Invoice</li>
							</ol>						
						</div>
						...
						<div class="row header">
							<div class="col-sm-4">					
								<div class="panel panel-body bk-bg-white">
									<h5><em>From:</em></h5>
									<p><strong>YourAgent.com</strong></p>
									<p>Blackstreet No. 256, 1256 California, USA</p>											
									<p>Phone: +12 456 458 125</p>
									<p>Fax: +12 456 458 126</p>
								</div>							
							</div>
							<div class="col-sm-4">								
								<div class="panel panel-body bk-bg-white">
									<h5><em>To:</em></h5>
									<p><strong>DestinationClient.com</strong></p>
									<p>White Building No. 23, 3692 Nevada, USA</p>													
									<p>Phone: +65 256 478 458</p>
									<p>Fax: +65 256 478 459</p>
								</div>						
							</div>
							<div class="col-sm-4">							
								<div class="panel panel-body bk-bg-white">
									<h5><em>Details:</em></h5>
									<p>Invoice No.:<strong> 1234/FEB/15</strong></p>
									<p>Date: February 01, 2015</p>							
									<p>Account Name: DestinationClient.com</p>								
									<p>Payment Due: 15 days</p>
								</div>						
							</div>
						</div>						
									...
									<table class="table">
										...
										<tbody>
											<tr>
												...
												<td class="left">VPS Package</td>
												<td class="left">Hosting Purchased</td>
												<td class="center">1</td>
												<td class="right">$382,25</td>
												<td class="right">$382,25</td>                                        
											</tr>								
											<tr>
												<td class="center">2</td>
												<td class="left">Web Hosting</td>
												<td class="left">Hosting Purchased</td>
												<td class="center">2</td>
										...
										<table class="table table-clear">
											<tbody>
												<tr>
													...
													<td class="right">$412,25</td>                                        
												</tr>
												<tr>
													<td class="left"><strong>Discount (25%)</strong></td>
												...
												<tr>
													...
													<td class="right"><strong>$340,11</strong></td>                                        
												</tr>                                  
											</tbody>
										</table>
										<a href="" class="btn btn-default bk-padding-5" onclick="javascript:window.print();"><i class="fa fa-print"></i> Print</a>
										<a href="" class="btn btn-primary bk-padding-5"><i class="fa fa-usd"></i> Proceed to Payment</a>
									</div>
								</div>
							</div>
						</div>	
