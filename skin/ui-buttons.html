		...
		<div class="navbar" role="navigation">
			<div class="container-fluid container-nav">
				...
				<ul class="nav navbar-nav navbar-actions navbar-left">
					<li class="visible-md visible-lg"><a href="ui-buttons.html#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
					<li class="visible-xs visible-sm"><a href="ui-buttons.html#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>			
				</ul>
				<!-- Navbar Left -->
									...
									<div class="btn-toolbar" role="toolbar">
										<div class="bk-margin-5 btn-group dropup">
											...
											<ul class="dropdown-menu" role="menu">
												<li><a href="ui-buttons.html#">Action</a></li>
												<li><a href="ui-buttons.html#">Another action</a></li>
												<li><a href="ui-buttons.html#">Something else here</a></li>
												<li class="divider"></li>
												<li><a href="ui-buttons.html#">Separated link</a></li>
											</ul>
										</div>
										<div class="bk-margin-5 btn-group dropup">
