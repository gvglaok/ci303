...
<html lang="en">
	...
	<head>
		...
		<title>Elements | Nadhif - Responsive Admin Template</title>
		...
		<div class="navbar" role="navigation">
			<div class="container-fluid container-nav">
				...
				<ul class="nav navbar-nav navbar-actions navbar-left">
					<li class="visible-md visible-lg"><a href="form-elements.html#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
					<li class="visible-xs visible-sm"><a href="form-elements.html#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>			
				</ul>
				<!-- Navbar Left -->
				...
				<div class="main ">
					...
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
							<div class="panel">
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-indent red"></i>Example Form</h6>							
								</div>
								<div class="panel-body">
									<form action="" method="post">
										<div class="form-group">
									...
									<form class="form-horizontal form-bordered" action="#">							
										...
										<div class="form-group">
											...
											<div class="col-md-6 col-xs-11">
												<a href="#" class="btn btn-sm btn-primary" data-plugin-colorpicker data-color-format="hex" data-color="rgb(42,111,244)">Select color</a>
											</div>
										</div>								
									</form>
								</div>
					...
					<div class="row hideInIE8">
						<div class="col-lg-12">
							<div class="panel">
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-indent"></i>Checkboxes and Radios</h6>						
									<div class="panel-actions">
										<a href="form-elements.html#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
										<a href="form-elements.html#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
										<a href="form-elements.html#" class="btn-close"><i class="fa fa-times black"></i></a>
