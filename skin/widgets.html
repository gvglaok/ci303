...
<html lang="en">
	...
	<head>
		...
		<title>UI Widgets | Nadhif - Responsive Admin Template</title>
			...
			<div class="row">
				...
				<div class="main ">
					...
					<div class="row">
							...
							<div class="panel bk-widget bk-border-off">
								<div class="panel-body text-left bk-bg-white bk-padding-top-15 bk-padding-bottom-15">
									<div class="row">
										...
										<div class="col-xs-4 bk-vcenter text-right">
											<div class="bk-avatar">
												<img src="assets/img/avatar1.jpg" alt="" class="img-circle bk-img-60 bk-border-info bk-border-3x" />
											</div>
										</div>
									</div>
								</div>
								...
								<div class="panel-body bk-ltr bk-bg-white bk-padding-off">
									<div class="row text-center">
										<a class="col-xs-3 bk-bg-white bk-bg-darken bk-fg-success bk-padding-top-20 bk-padding-bottom-20">
											<i class="fa fa-linkedin"></i><br>
											<small>Linkedin</small>
										</a>
										<a class="col-xs-3 bk-bg-white bk-bg-darken bk-fg-primary bk-padding-top-20 bk-padding-bottom-20">
											<i class="fa fa-facebook"></i><br>
											<small>Facebook</small>
										</a>
										<a class="col-xs-3 bk-bg-white bk-bg-darken bk-fg-info bk-padding-top-20 bk-padding-bottom-20">
											<i class="fa fa-twitter"></i><br>
											<small>Twitter</small>
										</a>
										<a class="col-xs-3 bk-bg-white bk-bg-darken bk-fg-danger bk-padding-top-20 bk-padding-bottom-20">
											<i class="fa fa-google-plus"></i><br>
											<small>Google+</small>
										</a>
									</div>
								</div>
								<div class="panel-body bk-bg-white bk-padding-5">
									<div class="row">
										<div class="col-xs-6">
						...
						<div class="col-md-4">
							<div class="panel bk-widget bk-border-off bk-webkit-fix">
								<div class="panel-body bk-bg-white bk-fg-info bk-ltr bk-padding-15">
									<div class="row">
							...
							<div class="panel bk-widget bk-border-off bk-noradius">
								<a class="panel-body bk-bg-inverse bk-fg-primary bk-bg-white bk-ltr bk-padding-15">
									<div class="row">
										<div class="col-xs-4 text-left bk-vcenter bk-padding-off">
							...
							<div class="panel bk-widget bk-border-off bk-noradius">
								...
								<div class="panel-body bk-ltr bk-padding-bottom-10 bk-avatar80-halfdown-after text-center bk-bg-white">
					...
					<div class="row">			
						<div class="col-md-8 col-xs-12">
							...
							<div class="panel bk-widget bk-border-off bk-noradius">
								<div class="panel-body bk-bg-primary text-center bk-padding-top-10 bk-padding-bottom-10">
									<div class="row">
										<div class="col-xs-8 text-left bk-vcenter">
											<h6 class="bk-margin-off">LATEST NEWS</h6>
										</div>
										<div class="col-xs-4 bk-vcenter text-right">
						...
						<div class="col-md-4 col-xs-12">
							...
							<div class="panel bk-widget bk-border-off ">
								<a class="panel-body text-center bk-padding-off bk-opacity bk-wrapper">
								...
								<div class="panel-body bk-padding-off-bottom bk-padding-off-top">
									<div class="row text-center">
					...
					<div class="row">
						<div class="col-md-6 col-xs-12">
							<div class="panel bk-widget bk-border-off">                    
								<div class="panel-body bk-padding-bottom-10 bk-bg-white">
									<div id="dotChart1" style="height:184px" ></div>
								</div>
								<hr class="bk-margin-off" />
								<div class="panel-body bk-padding-off-bottom bk-padding-off-top bk-bg-white">
									<div class="row text-center">
							...
							<div class="panel bk-widget bk-border-off bk-bg-primary">                    
								<div class="panel-body bk-padding-bottom-30 bk-padding-top-30 bk-bg-primary">
						...
						<div class="col-md-6 col-xs-12">
							<div class="panel bk-widget bk-border-off bk-webkit-fix">
								...
								<div class="panel-body bk-bg-very-light-gray bk-wrapper">
									<div class="row">
										<div class="col-xs-8 bk-vcenter">
