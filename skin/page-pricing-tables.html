...
<html lang="en">
	...
	<head>
		...
		<title>Pricing Tables | Nadhif - Responsive Admin Template</title>
	...
	<body>
		...
		<div class="navbar" role="navigation">
			<div class="container-fluid container-nav">
				...
				<ul class="nav navbar-nav navbar-actions navbar-left">
					<li class="visible-md visible-lg"><a href="page-pricing-tables.html#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
					<li class="visible-xs visible-sm"><a href="page-pricing-tables.html#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>			
				</ul>
				<!-- Navbar Left -->
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li class="active"><i class="fa fa-columns"></i>Pricing Tables</li>
							</ol>						
						</div>
					...
					<div class="col-md-12">
						<div class="pricing-table">
							<div class="pricing-wrap">
								<div class="plan bk-padding-left-10">
									<div class="bk-padding-left-40">
										<h2>$145</h2>
									</div>
									<div class="list-style bk-margin-top-20 bk-margin-bottom-20">
										<ul class="text-left">
									...
									<div class="bk-padding-left-40">
										<a class="btn btn-primary" href="page-pricing-tables.html#">Buy Now</a>
									</div>
								</div>
							</div>
							<div class="pricing-wrap most-popular">
								<div class="plan bk-padding-left-50">
									<h2>$450</h2>
									<div class="list-style bk-margin-top-30 bk-margin-bottom-20">
										<ul class="text-left">
											<li>PREMIUM PROFILE</li>
											<li>UNLIMITED FILE ACCESS</li>
											<li>FREE APPOINTMENTS</li>
											<li>UNLIMITED DISK SPACE</li>
											<li>UNLIMITED SUBDOMAIN</li>
											<li>5 BONUS POINTS EVERY MONTH</li>
										</ul>
									</div><br />
									<div class="bk-padding-left-20">
										<a class="btn btn-primary" href="page-pricing-tables.html#">Buy Now</a>
									</div>
								</div>
		...
		<!-- Pages JS -->
		<script src="assets/js/pages/pricing-tables.js"></script>
