...
<html lang="en">
	...
	<head>
		...
		<title>UI Progress-bars | Nadhif - Responsive Admin Template</title>
	...
	<body>
		...
		<div class="navbar" role="navigation">
			<div class="container-fluid container-nav">
				...
				<ul class="nav navbar-nav navbar-actions navbar-left">
					<li class="visible-md visible-lg"><a href="ui-progress-bars.html#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
					<li class="visible-xs visible-sm"><a href="ui-progress-bars.html#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>			
				</ul>
				<!-- Navbar Left -->
				...
				<div class="main ">
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li class="active"><i class="fa fa-align-left"></i>Progress</li>
							</ol>						
						</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel bk-bg-white">
								<div class="panel-heading">
									<h6><i class="fa fa-align-left red"></i>Standard Basic</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times black"></i></a>
									</div>
								</div>
						...
						<div class="col-md-6">
							<div class="panel bk-bg-white">
								<div class="panel-heading">
									<h6><i class="fa fa-align-left red"></i>Standard With label</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times black"></i></a>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel bk-bg-white">
								<div class="panel-heading">
									<h6><i class="fa fa-align-left red"></i>Standard Contextual alternatives</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times black"></i></a>
								...
								<div class="panel-body">						
									<div class="progress light progress-xl ">
										<div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width: 50%">
											<span class="sr-only">50% Complete (primary)</span>
										</div>
									</div>
									<div class="progress light progress-xl ">
						...
						<div class="col-md-6">
							<div class="panel bk-bg-white">
								<div class="panel-heading">
									<h6><i class="fa fa-align-left red"></i>Standard Contextual With label</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times black"></i></a>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel bk-bg-white">
								<div class="panel-heading">
									<h6><i class="fa fa-align-left red"></i>Standard Striped</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times black"></i></a>
								...
								<div class="panel-body">															
									<div class="progress light progress-xl  progress-striped">
										<div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 80%">
						...
						<div class="col-md-6">
							<div class="panel bk-bg-white">
								<div class="panel-heading">
									<h6><i class="fa fa-align-left red"></i>Standard Active</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times black"></i></a>
								...
								<div class="panel-body">															
									<div class="progress light progress-xl  progress-striped active">
										<div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 80%">
											<span class="sr-only">80% Complete (primary)</span>
										</div>
									</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="panel bk-bg-white">
								<div class="panel-heading">
									<h6><i class="fa fa-align-left red"></i>Standard Stacked</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times black"></i></a>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel bk-bg-white">
								<div class="panel-heading">
									<h6><i class="fa fa-align-left red"></i>Middle Basic</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times black"></i></a>
						...
						<div class="col-md-6">
							<div class="panel bk-bg-white">
								<div class="panel-heading">
									<h6><i class="fa fa-align-left red"></i>Middle With label</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times black"></i></a>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel bk-bg-white">
								<div class="panel-heading">
									<h6><i class="fa fa-align-left red"></i>Middle Contextual alternatives</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times black"></i></a>
						...
						<div class="col-md-6">
							<div class="panel bk-bg-white">
								<div class="panel-heading">
									<h6><i class="fa fa-align-left red"></i>Middle Contextual With label</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times black"></i></a>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel bk-bg-white">
								<div class="panel-heading">
									<h6><i class="fa fa-align-left red"></i>Middle Striped</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times black"></i></a>
						...
						<div class="col-md-6">
							<div class="panel bk-bg-white">
								<div class="panel-heading">
									<h6><i class="fa fa-align-left red"></i>Middle Active</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times black"></i></a>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="panel bk-bg-white">
								<div class="panel-heading">
									<h6><i class="fa fa-align-left red"></i>Middle Stacked</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times black"></i></a>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel bk-bg-white">
								<div class="panel-heading">
									<h6><i class="fa fa-align-left red"></i>Thin Basic</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times black"></i></a>
								...
								<div class="panel-body">						
									<div class="progress light progress-sm ">
										<div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="width: 90%;">
											<span class="sr-only">90% Complete</span>
										</div>
									</div>
						...
						<div class="col-md-6">
							<div class="panel bk-bg-white">
								<div class="panel-heading">
									<h6><i class="fa fa-align-left red"></i>Thin With label</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times black"></i></a>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel bk-bg-white">
								<div class="panel-heading">
									<h6><i class="fa fa-align-left red"></i>Thin Contextual alternatives</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times black"></i></a>
						...
						<div class="col-md-6">
							<div class="panel bk-bg-white">
								<div class="panel-heading">
									<h6><i class="fa fa-align-left red"></i>Thin Contextual With label</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times black"></i></a>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel bk-bg-white">
								<div class="panel-heading">
									<h6><i class="fa fa-align-left red"></i>Thin Striped</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times black"></i></a>
								...
								<div class="panel-body">															
									<div class="progress light progress-sm  progress-striped">
										<div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 80%">
											<span class="sr-only">80% Complete (primary)</span>
										</div>
									</div>
						...
						<div class="col-md-6">
							<div class="panel bk-bg-white">
								<div class="panel-heading">
									<h6><i class="fa fa-align-left red"></i>Thin Active</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times black"></i></a>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="panel bk-bg-white">
								<div class="panel-heading">
									<h6><i class="fa fa-align-left red"></i>Thin Stacked</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times black"></i></a>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="panel bk-bg-white">
								<div class="panel-heading">
									<h6><i class="fa fa-align-left red"></i>Progress Bar Sizes</h6>
									<div class="panel-actions">
										<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
										<a href="ui-sliders-progress.html#" class="btn-close"><i class="fa fa-times black"></i></a>
								...
								<div class="panel-body">
									<div class="col-md-4">
										<div class="progress light progress-xs ">
											<div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%;">
												60%
											</div>
										</div>
										...
										<div class="progress light progress-md ">
											<div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%;">
												60%
											</div>
										</div>
										<div class="progress light progress-lg ">
											<div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%;">
												60%
											</div>
										</div>
									...
									<div class="col-md-4">
										<div class="progress light progress-xs  progress-striped active">
											<div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%;">
												60%
											</div>
										</div>
										...
										<div class="progress light progress-md  progress-striped active">
											<div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%;">
												60%
											</div>
										</div>
										<div class="progress light progress-lg  progress-striped active">
											<div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%;">
												60%
											</div>
										</div>
		...
		<!-- Pages JS -->
		<script src="assets/js/pages/ui-progress-bar.js"></script>
