...
<html lang="en">
	...
	<head>
		...
		<title>Compose | Nadhif - Responsive Admin Template</title>
		...
		<div class="navbar" role="navigation">
			<div class="container-fluid container-nav">
				...
				<ul class="nav navbar-nav navbar-actions navbar-left">
					<li class="visible-md visible-lg"><a href="page-inbox-compose.html#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
					<li class="visible-xs visible-sm"><a href="page-inbox-compose.html#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>			
				</ul>
				<!-- Navbar Left -->
								...
								<div class="panel-body">
									<form class="form-horizontal bk-margin-top-10" role="form">
										<div class="form-group">
											...
											<div class="col-sm-11">
												<input type="email" class="form-control bk-border-off" id="to" />
											</div>
										</div>
										<hr />
										<div class="form-group">
											...
											<div class="col-sm-11">
												<input type="email" class="form-control bk-border-off" id="cc" />
											</div>
										</div>
										<hr />
										<div class="form-group">
											...
											<div class="col-sm-11">
												<input type="email" class="form-control bk-border-off" id="bcc" />
											</div>
										</div>
										<hr />
										...
										<div class="btn-group bk-padding-top-20 bk-padding-bottom-20 bk-padding-left-10">
